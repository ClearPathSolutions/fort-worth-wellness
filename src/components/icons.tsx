...
// Social brand marks.
//
// These are official logotypes, not UI glyphs, so unlike everything above they
// are filled paths at their real proportions rather than 1.6px strokes — a
// stroked Facebook "f" or LinkedIn "in" reads as a drawing of the logo instead
// of the logo. Colour still comes from `currentColor` so they tint with the
// surrounding text.
// ---------------------------------------------------------------------------
...
export const Instagram = (p: IconProps) => (
  <svg {...brand(p)}>
    ...
    <path d="M19.85 5.6a1.44 1.44 0 1 1-1.44-1.44 1.44 1.44 0 0 1 1.44 1.44Z" />
  </svg>
);
...
export const Linkedin = (p: IconProps) => (
  // The official mark's "in" sits low in a 24-box once the enclosing square is
  // dropped; the nudge re-centres it against Instagram and Facebook in a row.
  <svg {...brand(p)}>
    <g transform="translate(0 -0.9)">
      <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286Z" />
      <path d="M5.337 7.433a2.063 2.063 0 1 1 0-4.126 2.063 2.063 0 0 1 0 4.126Z" />
